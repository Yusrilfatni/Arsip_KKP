            ...
            <div class="box-body">
                <div class="table-responsive">
                    <table class=" table table-bordered table-hover" id="table-id" style="font_size:14px;">
                        ...
                        <tbody>
                            <?php $i = 1; ?>
                            <?php foreach ($berkas_penghargaan as $lbs) : ?>
                                <tr>
                                    <td><?php echo $i++; ?></td>
                                    <td><?php echo $lbs['nama_file']; ?></td>
                                    <td><?php echo $lbs['file_upload']; ?></td>
                                    <td><?php echo format_indo($lbs['date_upload']); ?></td>
                                    <td><a href="<?php echo base_url('user/file_download_berkas_penghargaan/' . $lbs['id']); ?>" class="btn btn-success btn-sm btn-block">Download</a></td>
                                    <td> <a href="<?php echo base_url('user/edit_berkas_penghargaan/' . $lbs['id']); ?>" class="btn btn-info btn-sm btn-block">Detail</a></td>
                                    <td><a href="<?php echo base_url('user/del_berkas_penghargaan/' . $lbs['id']); ?>" class="tombol-delete btn btn-danger btn-sm btn-block">Hapus</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" style="font-weight:800;">Input Berkas Penghargaan</h3>
            </div>
            <div class="modal-body">
                <?php echo form_open_multipart('user/berkas_penghargaan'); ?>
